...
ques_info = pd.read_csv(origdatadir + 'question_info.txt',delimiter = '\t', header=None, usecols=[4,5,6])#,nrows=5)#, skiprows = 10)
...
ques_info.columns = ['upvotes','numAnswers','numQAns']
...
op_path = 'uni_q2q_features_sim_temp2'
