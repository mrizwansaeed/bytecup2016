...
filename1 = 'computed_score_all_training2.csv'
filename3 = 'computed_score_all_submission2.csv'
filename4 = 'computed_score_all_testing2.csv'
...
features = np.arange(1,numScores+1) #0.478304451155421 
#features = [2,4,5,7,8,9,11,12,13,14]
...
convert_letor("train.txt", training, features)
print 'Writing testing'
convert_letor2("test.txt", testing, features)
print 'Writing submission'
convert_letor2("submit.txt", submission, features)

filename1 = 'reduced_computed_score_all_training2.csv'
filename3 = 'reduced_computed_score_all_submission2.csv'
filename4 = 'reduced_computed_score_all_testing2.csv'
