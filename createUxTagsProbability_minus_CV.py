...
invited_info = pd.read_csv(moddatadir + 'merged_invited_info_training.csv',delimiter = ',')#,nrows=10)
...
np.save('userQtagProbmat_minus_CV',userQtagProbmat_minus)
np.save('userQtagProbRank_minus_CV',userQtagEmat_minus)
np.save('userLikely2answer_minus_CV',userLikely2answer_minus)
np.save('userLikely2answersq_minus_CV',userLikely2answersq_minus)
np.save('qLikely2banswered_minus_CV', qLikely2banswered_minus)
np.save('qLikely2banswered_sq_minus_CV', qLikely2banswered_sq_minus)
