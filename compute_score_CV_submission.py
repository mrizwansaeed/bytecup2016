...
no_label_info = pd.read_csv(moddatadir + 'merged_invited_info_submission.csv',delimiter = ',') #, nrows=2)
...
#uxq_mat = np.load('UxQAmatrix_minus_CV.npy')
print ('Reading question tags matrix')
#op_path = 'uni_q2q_char_sim_final'
...
n = '2'
filename = 'computed_score_CV_submission' + n + '.csv'
