...
no_label_info = pd.read_csv(moddatadir + 'merged_invited_info_validation.csv',delimiter = ',') #, nrows=2)
#training_info = pd.read_csv(moddatadir + 'merged_invited_info_training2.csv',delimiter = ',') #, nrows=2)
...
op_path = 'uni_u2u_qhistory_sim_CV_final'
usersim = np.memmap(op_path, dtype='float32', mode='r', shape=(numUsers,numUsers))
print np.trace(usersim)
...
#no_label_info.to_csv('score6',index=False, columns = ['q_indx','user_indxore6'])
del quessim
#=======================================================================================================
#=======================================================================================================
#computing score based on feature similarity of questions
...
userQtagProbmat_minus  = np.load('userQtagProbmat_minus_CV.npy')      
usertagsQtagsmat_minus = np.load('usertagsQtagsmat_minus_CV.npy')
userQtagProbRank_minus = np.load('userQtagProbRank_minus_CV.npy')     
userLikely2answer_minus = np.load('userLikely2answer_minus_CV.npy')
userLikely2answersq_minus = np.load('userLikely2answersq_minus_CV.npy')
qLikely2banswered_minus = np.load('qLikely2banswered_minus_CV.npy')
qLikely2banswered_sq_minus = np.load('qLikely2banswered_sq_minus_CV.npy')
...
filename = 'computed_score_CV_validation' + n + '.csv'
